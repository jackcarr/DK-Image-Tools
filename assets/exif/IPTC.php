...
function Interpret_IPTC_to_HTML( $IPTC_info,$file)
{
        ...
        $input_open = '<input type="text" size="50" value="';
        $input_close = '">';

        // Create a string to receive the HTML
        $output_str ="";
        // $output_str = '<form action="" method="post">
        $output_str = '<input type="hidden" name="file-id" value="'.$file.'">';
        ...
        if ( $IPTC_info !== FALSE )
        {
                ...
                {
                        $drop_down = '<select name="target-'. $IPTC_Record['IPTC_Type'] .'">
                        <option value=""></option>
                        <option value="agency-description">Agency description</option>
                        <option value="creator">Creator</option>
                        <option value="copyright">Copyright</option>
                        <option value="title">Title</option>
                        </select>';
/*
                        <button name="description-'.$IPTC_Record['IPTC_Type'].'" onclick="return false">Desc</button>
                        <button name="photographer-'.$IPTC_Record['IPTC_Type'].'" onclick="return false">Photographer</button>
                        <button name="number-'.$IPTC_Record['IPTC_Type'].'" onclick="return false">Number</button>
                        <button name="copyright-'.$IPTC_Record['IPTC_Type'].'" onclick="return false">Copyright</button>
                        ';*/
                        ...
                        else
                        {
                                ...
                                switch ( $IPTC_Record['IPTC_Type'] )
                                {
                                        ...
                                        case "1:22":    // Envelope Record:File Format Version
                                                $output_str .= $IPTC_Record['IPTC_Type'];
                                                $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."$Record_Name</td><td class=\"IPTC_Value_Cell\">" . hexdec( bin2hex( $IPTC_Record['RecData'] ) ) . $IPTC_Record['IPTC_Type']."</td></tr>\n";
                                                break;

                                        case "1:90":    // Envelope Record:Coded Character Set
                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."$Record_Name</td><td class=\"IPTC_Value_Cell\">Decoding not yet implemented<br>\n (Hex Data: " .  bin2hex( $IPTC_Record['RecData'] )  .")</td></tr>\n";
                                                break;
                                        ...
                                        case "1:20":    // Envelope Record:File Format
                                                ...
                                                if ( array_key_exists( $formatno, $GLOBALS[ "IPTC_File Formats" ] ) )
                                                {
                                                        ...
                                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."File Format</td><td class=\"IPTC_Value_Cell\">". $GLOBALS[ "IPTC_File Formats" ][$formatno] . "</td></tr>\n";
                                                }
                                                else
                                                {
                                                        // No matching entry was found in lookup table - add message to html
                                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."File Format</td><td class=\"IPTC_Value_Cell\">Unknown File Format ($formatno)</td></tr>\n";
                                                }
                                                break;
                                        ...
                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">" . hexdec( bin2hex( $IPTC_Record['RecData'] ) ) .$IPTC_Record['IPTC_Type']."</td></tr>\n";
                                                break;
                                        ...
                                        case "2:80":
                                        // $output_str .= $IPTC_Record['IPTC_Type'];
                                                $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">" .  $input_open.$IPTC_Record['RecData'] . $input_close . $IPTC_Record['IPTC_Type']."</td></tr>\n";
                                                break; 
                                        ...
                                        case "2:42":    // Application Record: Action Advised
                                                ...
                                                {
                                                        // $output_str .= $IPTC_Record['IPTC_Type'];
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Kill</td></tr>\n";
                                                }
                                                elseif ( $IPTC_Record['RecData'] == "02" )
                                                {
                                                        // $output_str .= $IPTC_Record['IPTC_Type'];
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Replace</td></tr>\n";
                                                }
                                                elseif ( $IPTC_Record['RecData'] == "03" )
                                                {
                                                        // $output_str .= $IPTC_Record['IPTC_Type'];
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Append</td></tr>\n";
                                                }
                                                elseif ( $IPTC_Record['RecData'] == "04" )
                                                {
                                                        // $output_str .= $IPTC_Record['IPTC_Type'];
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Reference</td></tr>\n";
                                                }
                                                else
                                                {
                                                        // Unknown Action
                                                        // $output_str .= $IPTC_Record['IPTC_Type'];
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Unknown : " . nl2br( HTML_UTF8_Escape( $IPTC_Record['RecData'] ) ) ."</td></tr>\n";
                                                }
                                                break;
                                        ...
                                        case "2:08":    // Application Record:Editorial Update
                                                if ( $IPTC_Record['RecData'] == "01" )
                                                {
                                                        // Additional Language
                                                        // $output_str .= $IPTC_Record['IPTC_Type'];
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Additional language</td></tr>\n";
                                                }
                                                else
                                                {
                                                        // Unknown Value
                                        ...
                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                ...
                                                $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">" . $input_open . nl2br( HTML_UTF8_Escape( $date_array['Day'] . "/" . $date_array['Month'] . "/" . $date_array['Year'] ) ) . $input_close ."</td></tr>\n";
                                                break;
                                        ...
                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                ...
                                                $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">" . $input_open . nl2br( HTML_UTF8_Escape( $time_array['Hour'] . ":" . $time_array['Minute'] . ":" . $time_array['Second'] . " ". $time_array['PlusMinus'] . $time_array['Timezone'] ) ) . $input_close."</td></tr>\n";
                                                break;
                                        ...
                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                ...
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Morning</td></tr>\n";
                                                }
                                                elseif ( $IPTC_Record['RecData'] == "p" )
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Evening</td></tr>\n";
                                                }
                                                elseif ( $IPTC_Record['RecData'] == "b" )
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Both Morning and Evening</td></tr>\n";
                                                }
                                                else
                                                {
                                                        // Unknown Value
                                        ...
                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">460x128 pixel black and white caption image</td></tr>\n";
                                                break;
                                        ...
                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                ...
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">No Objectdata";
                                                }
                                                elseif ( $IPTC_Record['RecData']{0} == "9" )
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Supplemental objects related to other objectdata";
                                                }
                                                else
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Number of Colour Components : " . nl2br( HTML_UTF8_Escape( $IPTC_Record['RecData']{0} ) );
                                                }
                                        ...
                                        $output_str .= $IPTC_Record['IPTC_Type'];
                                                ...
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Landscape</td></tr>\n";
                                                }
                                                elseif ( $IPTC_Record['RecData'] == "P" )
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Portrait</td></tr>\n";
                                                }
                                                elseif ( $IPTC_Record['RecData'] == "S" )
                                                {
                                                        $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">Square</td></tr>\n";
                                                }
                                                else
                                                {
                                        ...
                                        default:        // All other records
                                                ...
                                                $output_str .= "<tr class=\"IPTC_Table_Row\"><td class=\"IPTC_Caption_Cell\">".$drop_down."</td><td class=\"IPTC_Value_Cell\">" .nl2br( HTML_UTF8_Escape( $IPTC_Record['RecData'] ) ) ."</td></tr>\n";
                                                break;
                                }
                        }
                }
