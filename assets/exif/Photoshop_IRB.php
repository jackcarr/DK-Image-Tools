...
function Interpret_IRB_to_HTML( $IRB_array, $file )
{
                ...
                foreach( $IRB_array as $IRB_Resource )
                {
                        ...
                        switch ( $IRB_Resource['ResID'] )
                        {
                                ...
                                case 0x0404 : // IPTC-NAA IIM Record
                                        $secondary_output_str .= Interpret_IPTC_to_HTML( get_IPTC( $IRB_Resource['ResData'] ),$file );
                                        break;
                                ...
                                case 0x040C : // Thumbnail Resource
                                        ...
                                        $link_str .= "?filename=";
                                        $link_str .= get_relative_path( $file, dirname(__FILE__) );
